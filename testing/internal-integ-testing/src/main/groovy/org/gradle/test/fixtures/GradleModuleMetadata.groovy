...
class GradleModuleMetadata {
    ...
    static class Coords {
        ...
        Coords(String group, String module, String version, @Nullable String url = null, String prefers = '', String strictly = '', List<String> rejectsVersion = [], String reason = null, Map<String, String> attributes = [:]) {
            this.group = group
            this.module = module
